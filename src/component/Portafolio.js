    ...
    return (
        <div className="page portafolio">
            ...
            <div className="contenedor-slider">
                <button onClick={() => modificarContador("-")} onKeyDown={handleKeyDown} tabIndex={0} className="btn-izq">{"<"}</button>
                <button onClick={() => modificarContador("+")} onKeyDown={handleKeyDown} tabIndex={0} className="btn-der">{">"}</button>
